...
<head>
    ...
    <title>Coverage for /usr/local/lib64/python3.6/site-packages/django/contrib/admin/views/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/usr/local/lib64/python3.6/site-packages/django/contrib/admin/views/__init__.py</b> :
